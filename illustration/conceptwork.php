...
<title>会社案内パンフレット｜Illustration｜ムーグラフィック[moographic]-イラストレーション/ウェブデザイン</title>
...
<section id="gallery" class="content">
	...
	<div class="breadcrumb">
		<ul class="breadcrumb_list">
			...
			<li class="breadcrumb_list-item">会社案内パンフレット</li>
		</ul>
	</div><!--/.breadcrumb-->
	...
	<div class="design-wrap">
		<div class="design-pic"><img src="/img/illustration/conceptwork.png" alt=""></div>
		<div class="design-txt">
			<h3 class="design-txt-heading">会社案内パンフレット / コンセプトワーク</h3>
			<p class="design-txt-description">コンセプトワーク様制作の会社案内パンフレット用カットイラストを制作させていただきました。</p>
