...
<title>ウェブメディア（転職情報サイト）｜Illustration｜ムーグラフィック[moographic]-イラストレーション/ウェブデザイン</title>
...
<section id="gallery" class="content">
	...
	<div class="breadcrumb">
		<ul class="breadcrumb_list">
			...
			<li class="breadcrumb_list-item">ウェブメディア（転職情報サイト）</li>
		</ul>
	</div><!--/.breadcrumb-->
	...
	<div class="design-wrap">
		<div class="design-pic"><img src="/img/illustration/manmaru.png" alt=""></div>
		<div class="design-txt">
			<h3 class="design-txt-heading">ウェブメディア（転職情報サイト） / まんまるeねっと</h3>
			<p class="design-txt-description">まんまるeねっと様が運営するウェブメディア（転職情報サイト）のカットイラストを制作させていただきました。</p>
