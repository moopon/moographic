...
<title>Distracted boy｜Illustration｜ムーグラフィック[moographic]-イラストレーション/ウェブデザイン</title>
...
<section id="gallery" class="content">
	...
	<div class="breadcrumb">
		<ul class="breadcrumb_list">
			...
			<li class="breadcrumb_list-item">Distracted boy</li>
		</ul>
	</div><!--/.breadcrumb-->
	...
	<div class="design-wrap">
		<div class="design-pic"><img src="/img/illustration/distracted_boy.png" alt=""></div>
		<div class="design-txt">
			<h3 class="design-txt-heading">Distracted boy / オリジナル</h3>
