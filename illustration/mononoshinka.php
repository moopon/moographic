...
<title>モノの進化まるわかり事典〈第2巻〉｜Illustration｜ムーグラフィック[moographic]-イラストレーション/ウェブデザイン</title>
...
<section id="gallery" class="content">
	...
	<div class="breadcrumb">
		<ul class="breadcrumb_list">
			...
			<li class="breadcrumb_list-item">モノの進化まるわかり事典〈第2巻〉</li>
		</ul>
	</div><!--/.breadcrumb-->
	...
	<div class="design-wrap">
		<div class="design-pic"><img src="/img/illustration/mono01.png" alt=""></div>
		<div class="design-pic"><img src="/img/illustration/mono02.png" alt=""></div>
		<div class="design-txt">
			<h3 class="design-txt-heading">モノの進化まるわかり事典〈第2巻〉 / Gakken</h3>
			<p class="design-txt-description">株式会社Gakken様発行の書籍「モノの進化まるわかり事典〈第2巻〉」のカットイラストを制作させていただきました。</p>
