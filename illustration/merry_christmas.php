...
<title>merry_christmas｜Illustration｜ムーグラフィック[moographic]-イラストレーション/ウェブデザイン</title>
...
<section id="gallery" class="content">
	...
	<div class="breadcrumb">
		<ul class="breadcrumb_list">
			...
			<li class="breadcrumb_list-item">merry_christmas</li>
		</ul>
	</div><!--/.breadcrumb-->
	...
	<div class="design-wrap">
		<div class="design-pic"><img src="/img/illustration/merry_christmas.png" alt="merry_christmas"></div>
		<div class="design-txt">
			<h3 class="design-txt-heading">merry_christmas / オリジナル</h3>
			
			<p class="design-txt-info">使用アプリケーション：Adobe Photoshop Sketch / Adobe Illustrator Draw / Adobe Fresco</p>
		</div>
	</div><!--/.design-wrap-->
