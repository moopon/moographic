...
<title>猫の日｜Illustration｜ムーグラフィック[moographic]-イラストレーション/ウェブデザイン</title>
...
<section id="gallery" class="content">
	...
	<div class="breadcrumb">
		<ul class="breadcrumb_list">
			...
			<li class="breadcrumb_list-item">猫の日</li>
		</ul>
	</div><!--/.breadcrumb-->
	...
	<div class="design-wrap">
		<div class="design-pic"><img src="/img/illustration/catdays.png" alt="猫の日"></div>
		<div class="design-txt">
			<h3 class="design-txt-heading">猫の日 / オリジナル</h3>
